...
CREATE TABLE ad_prescription (ad_presc_id INT AUTO_INCREMENT, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, presc_date DATETIME NOT NULL, dose VARCHAR(45) NOT NULL, frequency VARCHAR(45) NOT NULL, user_patient_id INT NOT NULL, med_form_id INT NOT NULL, comment LONGBLOB, INDEX med_form_id_idx (med_form_id), INDEX user_patient_id_idx (user_patient_id), PRIMARY KEY(ad_presc_id)) ENGINE = INNODB;
CREATE TABLE ad_role (role_id INT AUTO_INCREMENT, name VARCHAR(45) NOT NULL, PRIMARY KEY(role_id)) ENGINE = INNODB;
CREATE TABLE ad_user (user_id INT AUTO_INCREMENT, fname VARCHAR(45) NOT NULL, lname VARCHAR(45) NOT NULL, email VARCHAR(80), uname VARCHAR(45) NOT NULL, passw VARCHAR(45) NOT NULL, phone VARCHAR(45), ad_role_id INT NOT NULL, ad_function_id INT NOT NULL, unlock_code VARCHAR(50), INDEX ad_function_id_idx (ad_function_id), INDEX ad_role_id_idx (ad_role_id), PRIMARY KEY(user_id)) ENGINE = INNODB;
...
CREATE TABLE med_bnf_medicine (med_bnf_medicine_id INT, med_bnf_percentages_id INT NOT NULL, med_form_id INT NOT NULL, value FLOAT(18, 2) NOT NULL, INDEX med_form_id_idx (med_form_id), INDEX med_bnf_percentages_id_idx (med_bnf_percentages_id), PRIMARY KEY(med_bnf_medicine_id)) ENGINE = INNODB;
