...
abstract class BasePatientForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'geslacht'         => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'geslacht'         => new sfValidatorInteger(),
      ...
      'opmerkingen'      => new sfValidatorString(array('required' => false)),
      'voorgeschiedenis' => new sfValidatorString(),
