...
abstract class BaseMedBnfMedicineForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'med_bnf_percentages_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('MedBnfPercentage'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'med_bnf_percentages_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('MedBnfPercentage'))),
